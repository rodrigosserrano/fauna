                                ...
                                <div class="modal-pet-item">
                                    <form class="frm" id="form-alterar-pet">
                                        ...
                                        <section id="form-data">
                                            ...
                                            <div id="form-fields">
                                                <input id="frm_alterar_id_animal" type="hidden" name="id_animal">
                                                <input id="frm_alterar_id_usuario"  type="hidden" name="id_usuario">
                                                <input id="frm_alterar_nome_animal" type="text" class="form-input" name="nome_animal" placeholder="Nome" required>
                    ...
                    <section id="user-pets">
                        ...
                        <div class="pet">
                            ...
                            <button class="pet-pic-area" type="button">
                                <img class="pet-pic" src="<?= base_url() ?>assets/img/cachorro_login">
                            </button>
                            <span class="pet-name">Nome</span>
                        </div>
                        <!--  -->
                    </section>
