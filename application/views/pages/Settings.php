        ...
        <section id="config">
            ...
            <section id="config-info" class="tab-content">
                ...
                <!-- pet-view -->
                    ...
                    <div class="modal fade" id="pet-alterar-modal-<?= $dado_pet->id_animal?>" data-id="pet-view" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
