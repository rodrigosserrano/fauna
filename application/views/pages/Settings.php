                    ...
                    <form class="frm" id="form_alterar">
                        <section id="form-pic-area">
                            <div class="form-pic">
                                ...
                                <input type="file" accept="image/png, image/jpeg, image/gif" name="foto_usuario" enctype="multipart/form-data">
                            </div>
                        </section>
                                        ...
                                        <form class="frm" id="form-alterar-pet">
                                            <section id="form-pic-area">
                                                <div class="form-pic">       
                                                    ...
                                                    <input type="file" id="input-foto-animal-com-foto" accept="image/png, image/jpeg, image/gif" name="foto_animal" enctype="multipart/form-data">
                                                </div>
                                            </section>
                                    ...
                                    <div class="modal-pet-item">
                                        <form class="frm" id="form-criar-pet">
                                            <section id="form-pic-area">
                                                <div class="form-pic">
                                                    <p>+</p>
                                                    <input type="file" accept="image/png, image/jpeg, image/gif" name="foto_animal" enctype="multipart/form-data">
                                                </div>
                                            </section>
