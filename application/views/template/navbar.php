<nav id="navbar">
    ...
    <div id="nav-user">
        ...
        <a id="config-anchor" href="<?= base_url()?>usuario-dados" class="link"><img id="btn-config" src="<?= base_url() ?>assets/img/icon/config.png" alt="Configurações" title="Configurações"></a>
